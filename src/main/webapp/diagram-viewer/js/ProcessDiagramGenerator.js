...
var ProcessDiagramGenerator = {
	...
	init : function() {
		...
		this.activityDrawInstructions["startEvent"] = function() {
			...
			processDiagramCanvas.drawNoneStartEvent(activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight());
		};
		...
		this.activityDrawInstructions["startTimerEvent"] = function() {
			...
			processDiagramCanvas.drawTimerStartEvent(activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight(), isInterrupting, activityImpl
							.getProperty("name"));
		};
		...
		this.activityDrawInstructions["messageStartEvent"] = function() {
			...
			var isInterrupting = activityImpl.getProperty("isInterrupting");
			processDiagramCanvas.drawMessageStartEvent(activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight(), isInterrupting, activityImpl
							.getProperty("name"));
		};
		...
		this.activityDrawInstructions["startSignalEvent"] = function() {
			...
			var isInterrupting = activityImpl.getProperty("isInterrupting");
			processDiagramCanvas.drawSignalStartEvent(activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight(), isInterrupting, activityImpl
							.getProperty("name"));
		};
		...
		this.activityDrawInstructions["startMultipleEvent"] = function() {
			...
			var isInterrupting = activityImpl.getProperty("isInterrupting");
			processDiagramCanvas.drawMultipleStartEvent(activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight(), isInterrupting, activityImpl
							.getProperty("name"));
		};
		...
		this.activityDrawInstructions["intermediateSignalCatch"] = function() {
			...
			var isInterrupting = activityImpl.getProperty("isInterrupting");
			processDiagramCanvas.drawCatchingSignalEvent(activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight(), isInterrupting, null);

			var label = ProcessDiagramGenerator.getActivitiLabel(activityImpl);
			if (label)
				processDiagramCanvas.drawLabel(label.text, label.x, label.y,
		...
		this.activityDrawInstructions["intermediateMessageCatch"] = function() {
			...
			var isInterrupting = activityImpl.getProperty("isInterrupting");
			processDiagramCanvas.drawCatchingMessageEvent(activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight(), isInterrupting, null);
		...
		this.activityDrawInstructions["intermediateMultipleCatch"] = function() {
			...
			var isInterrupting = activityImpl.getProperty("isInterrupting");
			processDiagramCanvas.drawCatchingMultipleEvent(activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight(), isInterrupting, null);
		...
		this.activityDrawInstructions["intermediateSignalThrow"] = function() {
			...
			processDiagramCanvas.drawThrowingSignalEvent(activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight(), activityImpl.getProperty("name"));
		...
		this.activityDrawInstructions["intermediateMessageThrow"] = function() {
			...
			processDiagramCanvas.drawThrowingMessageEvent(activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight(), activityImpl.getProperty("name"));
		...
		this.activityDrawInstructions["intermediateMultipleThrow"] = function() {
			...
			processDiagramCanvas.drawThrowingMultipleEvent(activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight(), activityImpl.getProperty("name"));
		...
		this.activityDrawInstructions["intermediateThrowEvent"] = function() {
			...
			processDiagramCanvas.drawThrowingNoneEvent(activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight(), activityImpl.getProperty("name"));
		...
		this.activityDrawInstructions["endEvent"] = function() {
			...
			processDiagramCanvas.drawNoneEndEvent(activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight());
		};
		...
		this.activityDrawInstructions["errorEndEvent"] = function() {
			...
			processDiagramCanvas.drawErrorEndEvent(activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight(), null);
		...
		this.activityDrawInstructions["messageEndEvent"] = function() {
			...
			processDiagramCanvas.drawMessageEndEvent(activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight(), null);
		...
		this.activityDrawInstructions["signalEndEvent"] = function() {
			...
			processDiagramCanvas.drawSignalEndEvent(activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight(), null);
		...
		this.activityDrawInstructions["multipleEndEvent"] = function() {
			...
			processDiagramCanvas.drawMultipleEndEvent(activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight(), null);
		...
		this.activityDrawInstructions["terminateEndEvent"] = function() {
			...
			processDiagramCanvas.drawTerminateEndEvent(activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight());
		...
		this.activityDrawInstructions["errorStartEvent"] = function() {
			...
			processDiagramCanvas.drawErrorStartEvent(activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight(), activityImpl.getProperty("name"));
		...
		this.activityDrawInstructions["task"] = function() {
			 ...
			 * processDiagramCanvas.drawTask(activityImpl.getProperty("name"),
			 * activityImpl.getX(), activityImpl.getY(),
			 * activityImpl.getWidth(), activityImpl.getHeight(), thickBorder);
			 */
		};
		...
		this.activityDrawInstructions["userTask"] = function() {
			...
			processDiagramCanvas.drawUserTask(activityImpl.getProperty("name"),
					activityImpl.getX(), activityImpl.getY(), activityImpl
							.getWidth(), activityImpl.getHeight());
		};
		...
		this.activityDrawInstructions["scriptTask"] = function() {
			...
			processDiagramCanvas.drawScriptTask(activityImpl
							.getProperty("name"), activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight());
		};
		...
		this.activityDrawInstructions["serviceTask"] = function() {
			...
			processDiagramCanvas.drawServiceTask(activityImpl
							.getProperty("name"), activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight());
		};
		...
		this.activityDrawInstructions["receiveTask"] = function() {
			...
			processDiagramCanvas.drawReceiveTask(activityImpl
							.getProperty("name"), activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight());
		};
		...
		this.activityDrawInstructions["sendTask"] = function() {
			...
			processDiagramCanvas.drawSendTask(activityImpl.getProperty("name"),
					activityImpl.getX(), activityImpl.getY(), activityImpl
							.getWidth(), activityImpl.getHeight());
		};
		...
		this.activityDrawInstructions["manualTask"] = function() {
			...
			processDiagramCanvas.drawManualTask(activityImpl
							.getProperty("name"), activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight());
		};
		...
		this.activityDrawInstructions["businessRuleTask"] = function() {
			...
			processDiagramCanvas.drawBusinessRuleTask(activityImpl
							.getProperty("name"), activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight());
		};
		...
		this.activityDrawInstructions["exclusiveGateway"] = function() {
			...
			processDiagramCanvas.drawExclusiveGateway(activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight());
		};
		...
		this.activityDrawInstructions["inclusiveGateway"] = function() {
			...
			processDiagramCanvas.drawInclusiveGateway(activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight());
		};
		...
		this.activityDrawInstructions["parallelGateway"] = function() {
			...
			processDiagramCanvas.drawParallelGateway(activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight());
		};
		...
		this.activityDrawInstructions["eventBasedGateway"] = function() {
			...
			processDiagramCanvas.drawEventBasedGateway(activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight());
		};
		...
		this.activityDrawInstructions["boundaryTimer"] = function() {
			...
			var isInterrupting = activityImpl.getProperty("isInterrupting");
			processDiagramCanvas.drawCatchingTimerEvent(activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight(), isInterrupting, null);
		...
		this.activityDrawInstructions["boundaryError"] = function() {
			...
			var isInterrupting = activityImpl.getProperty("isInterrupting");
			processDiagramCanvas.drawCatchingErrorEvent(activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight(), isInterrupting, null);
		...
		this.activityDrawInstructions["subProcess"] = function() {
			...
			var isTriggeredByEvent = activityImpl
			...
			if (isExpanded != undefined && isExpanded == false) {
				processDiagramCanvas.drawCollapsedSubProcess(activityImpl
								.getProperty("name"), activityImpl.getX(),
						activityImpl.getY(), activityImpl.getWidth(),
						activityImpl.getHeight(), isTriggeredByEvent);
			} else {
				processDiagramCanvas.drawExpandedSubProcess(activityImpl
								.getProperty("name"), activityImpl.getX(),
						activityImpl.getY(), activityImpl.getWidth(),
						activityImpl.getHeight(), isTriggeredByEvent);
			}
		...
		this.activityDrawInstructions["callActivity"] = function() {
			...
			var processDiagramCanvas = this.processDiagramCanvas;
			processDiagramCanvas.setConextObject(activityImpl);
			processDiagramCanvas.drawCollapsedCallActivity(activityImpl
							.getProperty("name"), activityImpl.getX(),
					activityImpl.getY(), activityImpl.getWidth(), activityImpl
							.getHeight());
		};
	...
	getActivitiLabel : function(activityImpl) {
		/*
		 * TODO: Label object should be in activityImpl and looks like: { x:
		 * 250, y: 250, width: 80, height: 30 } And then: if
		 * (!activityImpl.label) return null; var label = activityImpl.label;
		 * label.text = activityImpl.name; return label;
		 */
		...
		return {
			...
			y : activityImpl.getY() + .5 + activityImpl.getHeight()
					+ ICON_PADDING,
			width : 100,
			height : 0
		};
	...
	generateDiagram : function(processDefinitionDiagramLayout) {
		...
		if (this.getProcessDiagram(processDefinitionId) != undefined) {
			...
			// console.log("ProcessDiagram '" + processDefinitionId + "' is
			// already generated. Just show it.");
			return;
		}
		var processDiagram = this
				.initProcessDiagramCanvas(processDefinitionDiagramLayout);
		...
		if (processDefinitionDiagramLayout.participantProcess != undefined) {
			...
			processDiagramCanvas.drawPoolOrLane(pProc.x, pProc.y, pProc.width,
					pProc.height, pProc.name);
		}
		...
		for (var i in laneSets) {
			...
			task1.add(laneSet.lanes, function(task1, lane) {
						...
						// console.log("--> laneId: " + lane.name + ", name: " +
						// lane.name);

						processDiagramCanvas.drawPoolOrLane(lane.x, lane.y,
								lane.width, lane.height, lane.name);
					});
		}
		...
		task1.add(activities, function(task1, activityJson) {
					...
					progress += step;
					pb1.set('value', parseInt(progress));
					// console.log(activitiesLength, "--> activityId: " +
					// activity.getId() + ", name: " +
					// activity.getProperty("name"));
					ProcessDiagramGenerator.drawActivity(processDiagramCanvas,
							activity);
				});
		...
		task1.add(function(task1) {
			if (!sequenceFlows)
				sequenceFlows = [];
				// console.log("> draw sequence flows, count:",
		...
		task1.add(sequenceFlows, function(task1, flow) {
					...
					// TODO: add source and destination for sequence flows in
					// REST
					// parse for test
					var f = flow.flow;
					var matches = f.match(/\((.*)\)--.*-->\((.*)\)/);
					...
					processDiagramCanvas.drawSequenceflow(waypoints,
							isConditional, isDefault, isHighLighted);
				});
	...
	initProcessDiagramCanvas : function(processDefinitionDiagramLayout) {
		...
		if (diagramCanvas) {
			...
			var diagramHolder = document
					.getElementById(this.options.diagramHolderId);
			if (!diagramHolder)
				throw {
			...
			diagramCanvas.init(maxX + 20, maxY + 20,
		...
		return this
				.getProcessDiagram(processDefinitionDiagramLayout.processDefinition.id);
		// return new DefaultProcessDiagramCanvas(maxX + 10, maxY + 10, minX,
		// minY);
	},

	drawActivity : function(processDiagramCanvas, activity,
		...
		if (activity.getProperty("multiInstance") != undefined
				|| activity.getProperty("collapsed") != undefined) {
			// console.log(activity.getProperty("name"), activity.properties);
			var multiInstanceSequential = (activity
					.getProperty("multiInstance") == "sequential");
			var multiInstanceParallel = (activity.getProperty("multiInstance") == "parrallel");
			var collapsed = activity.getProperty("collapsed");
			processDiagramCanvas.drawActivityMarkers(activity.getX(), activity
							.getY(), activity.getWidth(), activity.getHeight(),
	...
	setHighLights : function(highLights) {
		if (highLights.processDefinitionId == undefined) {
			// console.error("Process instance " + highLights.processInstanceId
			// + " doesn't exist");
			return;
		}

		var processDiagram = this
				.getProcessDiagram(highLights.processDefinitionId);
		if (processDiagram == undefined) {
			// console.error("Process diagram " + highLights.processDefinitionId
			// + " not found");
			return;
		}
	...
	drawHighLights : function(processInstanceId) {
		 ...
		 * {processInstanceId: processInstanceId}); $.ajax({ url: url, type:
		 * 'GET', dataType: 'json', cache: false, async: true,
		 * }).done(function(data) { var highLights = data; if (!highLights) {
		 * console.log("highLights not found"); return; }
		 * 
		 * console.log("highLights[" + highLights.processDefinitionId + "][" +
		 * processInstanceId + "]: ", highLights);
		 * 
		 * ProcessDiagramGenerator.setHighLights(highLights);
		 * }).fail(function(jqXHR, textStatus){ console.log('Get
		 * HighLights['+processDefinitionId+'] failure: ', textStatus, jqXHR);
		 * });
		 */
	...
	drawDiagram : function(processDefinitionId) {
		...
		// If processDefinitionId doesn't contain ":" then it's a
		// "processDefinitionKey", not an id.
		// Get process definition by key
		if (processDefinitionId.indexOf(":") < 0) {
			ActivitiRest.getProcessDefinitionByKey(processDefinitionId,
					this._drawDiagram);
		} else {
	...
	_drawDiagram : function() {
		...
		var processDiagram = ProcessDiagramGenerator
				.getProcessDiagram(processDefinitionId);

		if (processDiagram != undefined && processDiagram != null) {
			// console.log("Process diagram " + processDefinitionId + " is
			// already loaded");
			// return;
			...
			ProcessDiagramGenerator
					.generateDiagram(processDefinitionDiagramLayout);
		...
		ActivitiRest.getProcessDefinition(processDefinitionId,
	...
	_generateDiagram : function() {
		...
		// console.log("process-definition-diagram-layout["+processDefinitionDiagramLayout.processDefinition.id+"]:
	...
	getProcessDefinitionByKey : function(processDefinitionKey) {
		...
		$.ajax({
					...
					// console.error('Get diagram
					// layout['+processDefinitionKey+'] failure: ', textStatus,
					// jqXHR);
				});

		if (processDefinition) {
			// console.log("Get process definition by key '" +
			// processDefinitionKey + "': ", processDefinition.id);
	...
	addBreadCrumbsItem : function(processDefinitionId) {
		var TPL_UL_CONTAINER = '<ul></ul>', TPL_LI_CONTAINER = '<li id="{id}", processDefinitionId="{processDefinitionId}"><span>{name}</span></li>';
		...
		// TODO: if there is any items after current then remove that before
		// adding new item (m.b. it is a duplicate)
		var currentBreadCrumbsItemId = this.currentBreadCrumbsItemId;
		found = false;
		liListOld.each(function(index, item) {
					// console.warn("item:", $(this));
					if (!found
							&& currentBreadCrumbsItemId == $(this).attr("id")) {
						found = true;
						return;
					}
					if (found) {
	...
	_breadCrumbsItemClick : function() {
		var li = $(this), id = li.attr("id"), processDefinitionId = li
				.attr("processDefinitionId");
		// console.warn("_breadCrumbsItemClick: ", id, ", processDefinitionId:
		// ", processDefinitionId);
		...
		// Hide all diagrams
		var diagrams = $("#" + ProcessDiagramGenerator.options.diagramHolderId
				+ " div.diagram");
		diagrams.addClass("hidden");
