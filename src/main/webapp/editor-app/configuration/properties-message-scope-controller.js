...
angular.module('activitiModeler').controller('ActivitiMessageRefCtrl',
		['$scope', function($scope) {

			// Find the parent shape on which the message definitions are
			// defined
			var messageDefinitionsProperty = undefined;
			var parent = $scope.selectedShape;
			while (parent !== null && parent !== undefined
					&& messageDefinitionsProperty === undefined) {
				if (parent.properties
						&& parent.properties['oryx-messagedefinitions']) {
			...
			try {
				messageDefinitionsProperty = JSON
						.parse(messageDefinitionsProperty);
