...
var KisBpmInParametersCtrl = ['$scope', '$modal', '$timeout', '$translate',
		function($scope, $modal, $timeout, $translate) {

			// Config for the modal window
			var opts = {
				template : 'editor-app/configuration/properties/in-parameters-popup.html?version='
						+ Date.now(),
				scope : $scope
			};
...
var KisBpmInParametersPopupCtrl = ['$scope', '$q', '$translate',
		function($scope, $q, $translate) {
			...
			if ($scope.property.value !== undefined
				...
				$scope.parameters = angular
						.copy($scope.property.value.inParameters);
			} else {
				$scope.parameters = [];
			}
