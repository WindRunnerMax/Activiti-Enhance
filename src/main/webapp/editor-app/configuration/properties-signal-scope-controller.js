 ...
 */
angular.module('activitiModeler').controller('ActivitiSignalRefCtrl',
		['$scope', function($scope) {
			...
			while (parent !== null && parent !== undefined
					&& signalDefinitionsProperty === undefined) {
				if (parent.properties
						&& parent.properties['oryx-signaldefinitions']) {
			...
			try {
				signalDefinitionsProperty = JSON
						.parse(signalDefinitionsProperty);
